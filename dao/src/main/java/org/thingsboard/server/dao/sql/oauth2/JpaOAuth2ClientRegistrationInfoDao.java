...
public class JpaOAuth2ClientRegistrationInfoDao extends JpaAbstractDao<OAuth2ClientRegistrationInfoEntity, OAuth2ClientRegistrationInfo> implements OAuth2ClientRegistrationInfoDao {
    ...
    @Override
    public List<OAuth2ClientRegistrationInfo> findByDomainSchemeAndDomainName(SchemeType domainScheme, String domainName) {
        List<OAuth2ClientRegistrationInfoEntity> entities = repository.findAllByDomainSchemeAndName(domainScheme, domainName);
